...
const Kidscourses = () => {
    ...
    useEffect(()=>{
        ...
        .then(data=>setKidscourses(data.Kids));
    }, [])
    return (
...
<div id="kids-courses-part" className="  row row-cols-1 row-cols-md-3 g-4 h-50">

{
  kidscourses.map (kidscourse=> (
    <div id=' courses-part ' className="col course-container  ">
<div className=' shadow p-3 mb-5 bg-body-tertiary rounded'>
<div className="card h-100">
<div className='course-image'>
<img src={kidscourse.img} className="card-img-top" alt="..." />
</div>
<div className=" course-details card-body">
  <h2 className="  card-title title-name">{kidscourse.title}</h2>
